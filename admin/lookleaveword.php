...
<form name="form1" method="post" action="deleteleaveword.php">
  <tr bgcolor="#FFCF60"> 
    <td height="20" colspan="2"><div align="center"><font color="#FFFFFF">用户反馈管理</font></div></td>
  </tr>
  <tr> 
    <td height="40" colspan="2" bgcolor="#333333"><table width="750"  border="0" align="center" cellpadding="0" cellspacing="1">
		 ...
		 <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(($_GET[page])==""){
			 ...
			 $sql1=mysql_query("select * from tb_leaveword  order by createtime desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
        ...
        <tr> 
		  ...
		  <?php
		   $sql2=mysql_query("select usernc from tb_user where id='".$info1[userid]."'",$conn);
		   $info2=mysql_fetch_array($sql2);
		   echo $info2[usernc];
		  ?>
		  </div></td>
          <td height="20" bgcolor="#FFFFFF"><div align="center"><?php echo $info1[createtime];?></div></td>
