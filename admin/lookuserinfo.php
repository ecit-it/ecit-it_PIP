    ...
    <td height="98" bgcolor="#666666"><table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
	 ...
	 if($info[dongjie]==0)
      ...
      <tr>
        ...
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">密码：</div></td>
      ...
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">性别：</div></td>
      ...
      <tr>
        ...
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">登陆次数：</div></td>
      ...
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">最后登陆时间：</div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="left"><?php echo $info[lastlogintime];?></div></td>
      </tr>
      <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">IP号：</div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="left"><?php echo $info[ip];?></div></td>
      </tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">用户类型：</div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="left"><?php echo $info[usertype];?></div></td>
      </tr>
	  <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">密码问题：</div></td>
	  ...
	  <tr>
        ...
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">真实密码：</div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="left"><?php echo $info[truepwd];?></div></td>
      </tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">学校：</div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div align="left"><?php echo $info[school];?></div></td>
      </tr>
        <tr>
        <td height="20" bgcolor="#FFFFFF"><div align="center">现在所在城市：</div></td>
