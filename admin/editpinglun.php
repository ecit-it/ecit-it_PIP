...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <form name="form2" method="post" action="deletepingjia.php"> 
  <tr bgcolor="#FFCF60">
    <td height="20" colspan="2"><div align="center" class="style1">岗位评论管理</div></td>
  </tr>
  <tr>
    <td height="40" colspan="2" bgcolor="#666666"><table width="750" height="45" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="93" bgcolor="#FFFFFF"><div align="center">岗位名称</div></td>
      ...
      <tr>
		...
		<?php
		  $sql2=mysql_query("select * from tb_gouwu where id='".$info1[spid]."'",$conn);
