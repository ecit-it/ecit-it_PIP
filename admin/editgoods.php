...
<?php
	   $sql=mysql_query("select count(*) as total from tb_gouwu ",$conn);
...
<form name="form1" method="post" action="deletefxhw.php">
  ...
  <tr>
    <td height="75" bgcolor="#666666"><table width="750" height="86" border="0" cellpadding="0" cellspacing="1">
	  ...
	  <tr bgcolor="#FFCF60">
        <td height="20" colspan="10"><div align="center" class="style1">岗位信息编辑</div></td>
      </tr>
      <tr>
        <td width="59" height="28" bgcolor="#FFFFFF"><div align="center">复选</div></td>
        <td width="102" bgcolor="#FFFFFF"><div align="center">岗位名称</div></td>
        <td width="86" bgcolor="#FFFFFF"><div align="center">所属项目</div></td>
        <td width="71" bgcolor="#FFFFFF"><div align="center">岗位序号</div></td>
        <td width="60" bgcolor="#FFFFFF"><div align="center">剩余</div></td>
        <td width="60" bgcolor="#FFFFFF"><div align="center">开始时间</div></td>
        <td width="61" bgcolor="#FFFFFF"><div align="center">截止时间</div></td>
        <td width="60" bgcolor="#FFFFFF"><div align="center">已申请</div></td>
        <td width="112" bgcolor="#FFFFFF"><div align="center">发布时间</div></td>
	  ...
	  <?php
           ...
           $sql1=mysql_query("select * from tb_gouwu order by addtime desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
      ...
      <tr>
        ...
        <td height="25" bgcolor="#FFFFFF"><div align="center"><?php if($info1[shuliang]<0) {echo "申请完";}else {echo $info1[shuliang];}?></div></td>
...
<table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="585"><div align="right">&nbsp;本站共有岗位
        <?php
		   echo $total;
		  ?>
        ...
        <?php
		  ...
		  {
		  ?>
        <a href="editgangwei.php?page=1" title="首页"><font face="webdings"> 9 </font></a> <a href="editgangwei.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		    for($i=1;$i<=$pagecount;$i++){
		  ?>
        <a href="editgangwei.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php
		     }
		   }else{
		   for($i=1;$i<=4;$i++){	 
        ...
        <a href="editgangwei.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="editgangwei.php?page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a> <a href="editgangwei.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
        <?php }?>
    </div></td>
  </tr>
</table>
