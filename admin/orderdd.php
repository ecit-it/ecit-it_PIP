  ...
  <tr>
    <td bgcolor="#333333"><table width="750" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="saveorder.php?id=<?php echo $info[id];?>">
	  <tr>
        <td width="70" height="25" bgcolor="#FFFFFF"><div align="center" class="style3">申请单编号：</div></td>
        <td width="271" bgcolor="#FFFFFF"><div align="left"><?php echo $info[dingdanhao];?></div></td>
        <td width="100" bgcolor="#FFFFFF"><div align="center"><span class="style3">提交成功</span>
          <input type="checkbox" value="提交成功" name="ysk"></div></td>
        <td width="101" bgcolor="#FFFFFF"><div align="center"><span class="style3">正在审核</span>
          <input name="yfh" type="checkbox" value="正在审核"  >
        </div></td>
        <td width="100" bgcolor="#FFFFFF"><div align="center"><span class="style3">审核成功</span>
          <input name="ysh" type="checkbox" value="审核成功" >
        </div></td>
...
<table width="750" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="13"><div align="left">
      <div align="center" class="style2">注：一旦岗位确定审核成功，该岗位数量将自动从库中相应减少，并且不可更改！</div>
    </div></td>
  </tr>
</table>
<table width="750" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#CCCCCC"><table width="750" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr bgcolor="#FFCF60">
        <td width="138" height="20"><div align="center" class="style4">岗 位 名 称</div></td>
        <td width="138"><div align="center" class="style4">申请数量</div></td>
        <td width="138"><div align="center" class="style4">开始时间</div></td>
        <td width="331"><div align="center" class="style4">截止时间</div></td>
        </tr>
	 <?php
	   ...
	   for($i=0;$i<count($array)-1;$i++)
	    {
		  if($array[$i]!="")
		  {
	       $sql1=mysql_query("select * from tb_gouwu where id='".$array[$i]."'",$conn);
		   $info1=mysql_fetch_array($sql1);
		   $total=$total+$info1[huiyuanjia]*$arraysl[$i];
	 ?>
      <tr>
        <td height="25" bgcolor="#FFFFFF"><div align="left"> &nbsp;<?php echo $info1[mingcheng];?></div></td>
        <td height="25" bgcolor="#FFFFFF"><div align="center"><?php if($info1[shuliang]<0) echo "申请完了"; else echo $arraysl[$i];?></div></td>
...
<table width="750" height="195" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr>
    <td height="193" bgcolor="#333333"><table width="751" height="194" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr bgcolor="#FFCF60">
        <td height="20" colspan="2"><div align="center" class="style4">申请人信息</div></td>
      </tr>
      <tr>
        <td width="120" height="25" bgcolor="#FFFFFF"><div align="center" class="style3">申请人姓名：</div></td>
	  ...
	  <tr>
        <td height="35" bgcolor="#FFFFFF"><div align="center" class="style3">简单留言：</div></td>
        <td height="35" bgcolor="#FFFFFF"><div align="left"><?php echo $info[leaveword];?></div></td>
      </tr>
    </table></td>
  </tr>
</table>
