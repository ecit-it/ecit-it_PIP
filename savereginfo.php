...
$usertype=0;
$photo=$_POST["photo"];
if(mysql_query("insert into tb_user(usernc,truename,pwd,email,sex,tel,qq,address,city,school,logintimes,regtime,lastlogintime,ip,usertype,question,answer,truepwd,photo) values('$usernc','$truename','$pwd','$email','$sex','$tel','$qq','$address','$city ','$school','$logintimes','$regtime','$lastlogintime','$ip','$usertype','$question','$answer','$truepwd','$photo')",$conn))
{
