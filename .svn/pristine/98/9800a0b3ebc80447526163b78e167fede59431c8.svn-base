<table width="870" height="300" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <form name="form1" method="post" action="saveleaveword.php" onsubmit="return chkinput(this)">
    <tr>
      <td width="138" height="30"><div align="center">主&nbsp;&nbsp;题：</div></td>
    ...
    <tr>
      ...
      <td width="43" height="30"><img src="xym.php"></td>
      <td width="106"><input type="text" name="xym" size="5"></td>
      <td width="583"><input name="submit" type="submit" value="提交" />
        &nbsp;&nbsp;
