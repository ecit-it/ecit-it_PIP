...
<table width="870" height="197" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
  
    <td width="581" height="197" valign="top" bgcolor="#FFFFFF"><table width="845" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="845"><div align="left"><a href="javascript:history.back();">返回</a></div></td>
      </tr>
    </table>
      <table width="849" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="#FDE9C9">
          <td height="25" colspan="4"><div align="center" style="color: #990000">岗位评论</div></td>
        </tr>
        <?php
	   ...
	   else
	   {
		  ...
		  ?>
        <tr>
          <td width="108" height="20"><div align="center">岗位名称：</div></td>
          <td width="143"><div align="left">
              <?php 
		     $spid=$info1[spid];
			 $sql2=mysql_query("select mingcheng from tb_gouwu where id=".$spid."",$conn);
			 $info2=mysql_fetch_array($sql2);
			 echo $info2[mingcheng];
		  ?>
          </div></td>
          <td width="70"><div align="center">评论时间：</div></td>
          <td width="528"><div align="left"><?php echo $info1[time];?></div></td>
        </tr>
        <tr>
          ...
          <td height="20" colspan="3"><div align="left">
              <?php 
		     $spid=$info1[userid];
			 $sql3=mysql_query("select usernc from tb_user where id=".$spid."",$conn);
        ...
        <tr>
          ...
          <td height="20" colspan="3"><div align="left"><?php echo unhtml1($info1[title]);?></div></td>
        </tr>
        <tr>
          <td height="40"><div align="center">评论内容：</div></td>
          <td height="40" colspan="3" valign="bottom"><div align="left"><?php echo unhtml1($info1[content]);?></div></td>
        </tr>
        <tr>
      ...
      <table width="845" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="737"><div align="right"> &nbsp;本站共有该岗位评论&nbsp;
                  <?php
		   echo $total;
		  ?>
